...
if (jQuery) (function(jQuery){
	...
	jQuery.extend(jQuery.fn, {
		gsFileManager: function(o) {
			...
			hiddenElements += '<form action="/webfileupload" id="gsUploadForm" enctype="multipart/form-data" method="post"><input type="hidden" name="opt" value="11"><input type="hidden" name="dir" value="">';
